...
export namespace Prisma {
  ...
  */
  ...
  export type AdOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "price" | "category" | "description" | "contact" | "imageUrl" | "createdAt", ExtArgs["result"]["ad"]>
  ...
  interface AdFieldRefs {
    ...
    readonly contact: FieldRef<"Ad", 'String'>
  ...
  export type AdWhereInput = {
    ...
    contact?: StringFilter<"Ad"> | string
  ...
  export type AdScalarWhereWithAggregatesInput = {
    ...
    contact?: StringWithAggregatesFilter<"Ad"> | string
